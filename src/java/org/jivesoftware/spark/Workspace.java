...
/*import com.jivesoftware.spark.navigation.NavigationPlugin;
import com.jivesoftware.spark.organization.OrganizationPlugin;
import com.jivesoftware.spark.customizemenu.CustomizeMenuPlugin;*/
...
public class Workspace extends JPanel implements PacketListener {
    ...
    private Workspace() {
        ...
        workspacePane = UIComponentRegistry.createWorkspaceTabPanel(true ? JTabbedPane.TOP : JTabbedPane.BOTTOM);
        workspacePane.setBorder(BorderFactory.createEmptyBorder());
        //workspacePane.setBackground(new Color(53,136,204));
        // Add Panels.
       ...
       /* 自己加的菜单
        ...
        JLabel infoLabel = new JLabel(SparkRes.getImageIcon(SparkRes.INFO_WRITE_INFO_16x16));
      ...
      //  add(infoPanel, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    ...
    public void buildLayout() {
        ...
        navigationPlugin.initialize();
        
        CustomizeMenuPlugin customizeMenuPlugin = new CustomizeMenuPlugin();
        customizeMenuPlugin.initialize();
        
        OrganizationPlugin examplePlugin = new  OrganizationPlugin();
    ...
    private void handleIncomingPacket(Packet packet) {
        ...
        if (packet instanceof Message) {
            ...
            if (message.getProperty("notice")==null && offlineInformation != null && (Message.Type.chat == message.getType() ||

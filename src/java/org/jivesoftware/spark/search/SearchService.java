...
//            }
        ...
        findField.setBorder(BorderFactory.createLineBorder(Color.GRAY));
        workspace.add(this, new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

...
public final class MainWindow extends ChatFrame implements ActionListener {
    ...
    private MainWindow(String title, ImageIcon icon) {
        ...
        mainWindowBar.setBackground(new Color(53,136,204));
        // Add menubar
    ...
    private void buildMenu() {
        ...
        // Setup ResourceUtils
        ResourceUtils.resButton(connectMenu, "设置");
...
//	}
    ...
    private static void showAboutBox() {
        JOptionPane.showMessageDialog(SparkManager.getMainWindow(), "宝信软件即时通讯",
